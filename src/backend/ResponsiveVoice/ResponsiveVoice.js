...
/*if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        //defining the playwelcomemessage function
        self.playWelcomeMessage = function(){
            var welcomeMessage = "Welcome to DyslexAI. Would you like to keep text-to-voice on or turn it off? To turn off the text-to-voice, double-click the right side of the mouse.";
            self.speak(welcomeMessage, 'uk English Female');
        };
        var self = this;
        ...
        self.init = function() {
            ...
            //new changed made for the welcome message
            self.playWelcomeMessage();
            // Add listerner for right mouse button double-clocked to disable text-to-speech
            document.addEventListener('dblclicked', function(event){
                if (event.button === 2) {//right mouse button
                    self.cancel();//cancel any ongoing speech
                    alert.apply("text-to-speech has been turned off.");
                    }
                });
            }
...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        var self = this; // Move this line to the top
        ...
        //Fallback cache voices
        var cache_ios_voices = [{"name":"he-IL","voiceURI":"he-IL","lang":"he-IL"},{"name":"th-TH","voiceURI":"th-TH","lang":"th-TH"},{"name":"pt-BR","voiceURI":"pt-BR","lang":"pt-BR"},{"name":"sk-SK","voiceURI":"sk-SK","lang":"sk-SK"},{"name":"fr-CA","voiceURI":"fr-CA","lang":"fr-CA"},{"name":"ro-RO","voiceURI":"ro-RO","lang":"ro-RO"},{"name":"no-NO","voiceURI":"no-NO","lang":"no-NO"},{"name":"fi-FI","voiceURI":"fi-FI","lang":"fi-FI"},{"name":"pl-PL","voiceURI":"pl-PL","lang":"pl-PL"},{"name":"de-DE","voiceURI":"de-DE","lang":"de-DE"},{"name":"nl-NL","voiceURI":"nl-NL","lang":"nl-NL"},{"name":"id-ID","voiceURI":"id-ID","lang":"id-ID"},{"name":"tr-TR","voiceURI":"tr-TR","lang":"tr-TR"},{"name":"it-IT","voiceURI":"it-IT","lang":"it-IT"},{"name":"pt-PT","voiceURI":"pt-PT","lang":"pt-PT"},{"name":"fr-FR","voiceURI":"fr-FR","lang":"fr-FR"},{"name":"ru-RU","voiceURI":"ru-RU","lang":"ru-RU"},{"name":"es-MX","voiceURI":"es-MX","lang":"es-MX"},{"name":"zh-HK","voiceURI":"zh-HK","lang":"zh-HK"},{"name":"sv-SE","voiceURI":"sv-SE","lang":"sv-SE"},{"name":"hu-HU","voiceURI":"hu-HU"},{"name":"zh-TW","voiceURI":"zh-TW"},{"name":"es-ES","voiceURI":"es-ES"},{"name":"zh-CN","voiceURI":"zh-CN"},{"name":"nl-BE","voiceURI":"nl-BE"},{"name":"en-GB","voiceURI":"en-GB"},{"name":"ar-SA","voiceURI":"ar-SA"},{"name":"ko-KR","voiceURI":"ko-KR"},{"name":"cs-CZ","voiceURI":"cs-CZ"},{"name":"en-ZA","voiceURI":"en-ZA"},{"name":"en-AU","voiceURI":"en-AU"},{"name":"da-DK","voiceURI":"da-DK"},{"name":"en-US","voiceURI":"en-US"},{"name":"en-IE","voiceURI":"en-IE"},{"name":"hi-IN","voiceURI":"hi-IN"},{"name":"el-GR","voiceURI":"el-GR"},{"name":"ja-JP","voiceURI":"ja-JP"}];
        ...
        self.init = function() {
            ...
            document.addEventListener('dblclick', function(event){
                if (event.button === 2) {//right mouse button
                    self.cancel();//cancel any ongoing speech
                    alert("text-to-speech has been turned off.");
                }
            });
            self.Dispatch("OnLoad");
        };
...
class ResponsiveVoice {
    ...
    playWelcomeMessage() {
        const welcomeMessage = "Welcome to DyslexAI. Would you like to keep text-to-voice on or turn it off? To turn off the text-to-voice, double-click the right side of the mouse.";
        this.speak(welcomeMessage, 'UK English Female');
    }

    speakPageContent(content) {
        this.speak(content, 'UK English Female');
    }
    ...
    speak(text, voiceName) {
        if ('speechSynthesis' in window) {
            ...
            msg.text = text;
            msg.voice = speechSynthesis.getVoices().find(voice => voice.name === voiceName);
